  ...
  return (
    <CartContext.Consumer>
      {(value) => {
        ...
        const displayEmptyCart = () => {
          return (
            <div className="text-center">
              ...
              <div>
                <h4 className="font-medium text-xl mb-2">Empty Cart</h4>
                <Link to={"/"}>
                  <button className="bg-blue-500 text-white font-medium hover:bg-blue-400 hover:cursor-pointer p-2 rounded-md">
                    Shop Now
                  </button>
                </Link>
              </div>
        ...
        return (
          <>
            <div className="flex h-full flex-col overflow-y-auto bg-white shadow-xl  items-center min-h-3/4">
